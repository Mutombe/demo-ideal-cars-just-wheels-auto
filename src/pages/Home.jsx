  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <div className="absolute right-5 sm:right-8 top-1/2 -translate-y-1/2 z-30 flex flex-col gap-3">
        {heroImages.map((_, i) => (
          <button key={i} onClick={() => setCurrentSlide(i)} className={`w-[3px] transition-all duration-700 ${i === currentSlide ? 'h-10 bg-gold-500' : 'h-4 bg-white/20 hover:bg-white/40'}`} aria-label={`Slide ${i + 1}`} />
        ))}
      </div>
      ...
      <motion.div className="relative z-20 flex flex-col justify-center h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-36" style={{ y: textY, opacity }}>
        ...
        <div className="overflow-hidden">
          {['DRIVE YOUR', 'DREAM', 'OWN YOUR ROAD.'].map((line, i) => (
            <motion.div key={line} initial={{ y: '110%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.5 + i * 0.15, ease: [0.16, 1, 0.3, 1] }}>
              <h1 className={`font-heading leading-[0.92] tracking-tight ${line === 'DREAM' ? 'bg-gradient-to-r from-gold-500 via-gold-400 to-gold-600 bg-clip-text text-transparent italic' : 'text-white'}`}
                style={{ fontSize: 'clamp(2.2rem, 7vw, 4.5rem)', fontWeight: line === 'DREAM' ? 700 : 300 }}>{line}</h1>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 1.2 }} className="flex items-center gap-3 mt-8">
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>1,200+ Sold &middot; 30+ Brands &middot; Est. 2012</p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        <span className="text-white/10 text-[10px] uppercase tracking-[0.4em]" style={{ writingMode: 'vertical-rl', fontFamily: 'var(--font-sans)' }}>iDeal Cars &mdash; Harare, Zimbabwe</span>
      </div>
    </section>
  );
}
...
function MarqueeTicker() {
  const items = ['TOYOTA', 'HONDA', 'NISSAN', 'MERCEDES-BENZ', 'BMW', 'MAZDA', 'ISUZU', 'VOLKSWAGEN'];
                ...
                <Link to={`/services#${services?.items?.[i]?.slug || ''}`} className={`group relative block overflow-hidden ${i === 0 ? 'aspect-[16/9] sm:aspect-[2/1]' : 'aspect-[3/4]'}`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-10">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-gold-500 group-hover:translate-x-1 transition-transform duration-300">
                      <span className="text-xs uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>Explore</span><ArrowRight size={14} />
                    </div>
                  </div>
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
          <div>
            <div className="w-12 h-[2px] bg-gold-500 mb-6" />
            <p className="text-gold-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Recent Arrivals</p>
            <h2 className="font-heading text-white leading-[0.92] italic" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)' }}>Our <span className="text-gold-500">Stock</span></h2>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>The iDeal<br /><span className="text-gold-500">Difference</span></h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Since 2012, iDeal Cars and Just Wheels Auto have been Harare's go-to for quality pre-owned vehicles. Two brands united by one conviction -- buying a car should be exciting, transparent, and fair.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Over 1,200 vehicles placed with happy drivers across Zimbabwe. Japanese imports, European sedans, and rugged pickups -- all inspected, road-tested, and backed by our personal guarantee.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              ...
              <div><div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">1200+</div><div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Cars Sold</div></div>
              <div><div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">95%</div><div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Repeat Rate</div></div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.2 }} className="relative">
            <div className="relative">
              <div className="overflow-hidden"><img src="https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&q=80" alt="iDeal Cars showroom" className="w-full aspect-[4/5] object-cover object-center" loading="lazy" /></div>
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0571?w=600&q=80" alt="Vehicle ready for delivery" className="w-full aspect-square object-cover object-center" loading="lazy" />
              </div>
...
function WhyChooseUs() {
  ...
  const inView = useInView(ref, { once: true, margin: '-80px' });
  const points = [
    { title: 'Multi-Point Inspection', desc: 'Every vehicle is mechanically vetted and road-tested before it makes the showroom floor.' },
    { title: 'Transparent Pricing', desc: 'The number on the windscreen is the number you pay. No last-minute additions or hidden costs.' },
    { title: 'Japan Direct Access', desc: 'Auction-grade imports sourced to your exact specification and delivered to your door.' },
    { title: '12-Month Warranty', desc: 'Engine, gearbox, and drivetrain covered. Drive with complete peace of mind from day one.' },
  ];
  return (
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }} className="relative">
            <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80" alt="Premium vehicle" className="w-full aspect-[4/5] object-cover object-center" loading="lazy" />
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.15 }}>
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>Why Choose <span className="text-gold-500">iDeal</span></h2>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="iDeal Cars" className="w-full h-[130%] object-cover object-center" loading="lazy" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 1 }}>
          ...
          <h2 className="font-heading text-white leading-[0.92] italic mb-8" style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}>YOUR PERFECT CAR<br /><span className="text-gold-500">IS WAITING</span></h2>
